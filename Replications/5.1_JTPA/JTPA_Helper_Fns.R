...
#### Function that computes the doubly robust scores from alpha, sample data, ITR assignments, cross-fitted/true nuisance estimates, and eta ####
...
#### Function that computes the value of the objective function (generalized Lorenz) given some combination of linear policy parameters and eta, used for policy learning via simulated annealing ####
...
#### Function that computes the value of the objective function (generalized Lorenz) given some combination of cubic policy parameters and eta, used for policy learning via simulated annealing ####
### We use K = 2 for ease of computation
...
#### Function that computes the value of the objective function (generalized Lorenz) given some combination of (fixed) policy parameters and (variable) eta, used for policy evaluation via simulated annealing ####
