...
# Population-level comparisons between the 0.25-EWM, equality-minded, and 1-EWM policies using WGAN-JTPA data in Section 6.2.2
######################################
...
# These policy parameters correspond to the optimized welfare for alpha = 0.25 and 1 in truth_comparisons.csv (Table 13 in Appendix I.2)
