...
# Fan, Qi & Xu (2025), Table 12: n = 300, 5 alpha values
# Simulation results using data generating process in Appendix I.3; tau is specified as (I.1) in paper
