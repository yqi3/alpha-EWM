...
# Fan, Qi & Xu (2025), Tables 5 & 11: 6 alphas (alpha=1 is not used in main text)
# Population truths using data generating process in Section 6.2.1; tau is specified as (6.4) in paper
