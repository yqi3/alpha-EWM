...
# Fan, Qi & Xu (2025), Table 5: n = 300, 5 alpha values
# Simulation results using data generating process in Section 6.2.1; tau is specified as (6.4) in paper

# For reasonable run time, we recommend running this script with at least 30 CPUs simultaneously, or breaking the for loop into smaller sub-tasks.
...
for (alp in c(0.25,0.3,0.4,0.5,0.8)) {
  ...
  for (idx in 1:n_samples) {
    ...
    scores <- compute_scores(alp, datause$A, d_linear, datause$Y, mu1, mu0, datause$p, best_linear[6])/alp
...
#### Show Final Results ####
result_n300_alpha0.25
result_n300_alpha0.3
result_n300_alpha0.4
result_n300_alpha0.5
result_n300_alpha0.8
