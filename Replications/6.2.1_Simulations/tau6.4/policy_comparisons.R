...
# Fan, Qi & Xu (2025), Figure 6
# Population-level comparisons between the 0.25-EWM, equality-minded, and 1-EWM policies using data generating process in Section 6.2.1; tau is specified as (6.4) in paper
######################################
...
# These policy parameters correspond to the optimized welfare for alpha = 0.25 and 1 in truth_comparisons.csv (Table 11 in Appendix I.2)
