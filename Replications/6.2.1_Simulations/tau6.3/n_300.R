...
# Fan, Qi & Xu (2025), Table 4: n = 300, 5 alpha values
# Simulation results using data generating process in Section 6.2.1; tau is specified as (6.3) in paper
...
superpop <- read.csv("data_tau6.3.csv")
n_samples <- 1000
n <- 300
rate <- 0.6
n_limit <- 5
