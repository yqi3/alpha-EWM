...
# Fan, Qi & Xu (2025), Tables 4 & 10: 6 alphas (alpha=1 is not used in main text)
# Population truths using data generating process in Section 6.2.1; tau is specified as (6.3) in paper
