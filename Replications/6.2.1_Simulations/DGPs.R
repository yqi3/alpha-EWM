...
# Data generating processes for Fan, Qi & Xu (2025), Section 6.2.1
...
write.csv(d, "tau6.3/data_tau6.3.csv", row.names = F)
...
d <- cbind(d,Y)
colnames(d)[1:4] <- c("X1", "X2", "X3", "X4")
write.csv(d, "tau6.4/data_tau6.4.csv", row.names = F)
