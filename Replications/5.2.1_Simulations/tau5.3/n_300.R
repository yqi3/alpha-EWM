...
# Fan, Qi & Xu (2024), Table 4: n = 300, 6 alpha values
# Simulation results using data generating process in Section 5.2.1; tau is specified as (5.3) in paper
...
for (alp in c(0.25,0.3,0.4,0.5,0.8,1)) {
  ...
  if (alp == 0.25) {
    Lor_value_true <- 2.273532
  } else if (alp == 0.3) {
    Lor_value_true <- 2.766317
  } else if (alp == 0.4) {
    Lor_value_true <- 3.776976
  } else if (alp == 0.5) {
    Lor_value_true <- 4.819504
  } else if (alp == 0.8) {
    Lor_value_true <- 8.150835
  } else {
    Lor_value_true <- 10.67657
  }
