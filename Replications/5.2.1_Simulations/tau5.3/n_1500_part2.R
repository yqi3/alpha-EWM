...
# Fan, Qi & Xu (2024), Table 4: n = 1500, alphas = {0.4, 0.5, 1}
...
# For reasonable run time, we recommend running this script with at least 120 CPUs simultaneously, or breaking the for loop into smaller sub-tasks.
######################################
...
#### Show Final Results ####
result_n1500_alpha0.4
result_n1500_alpha0.5
result_n1500_alpha1
