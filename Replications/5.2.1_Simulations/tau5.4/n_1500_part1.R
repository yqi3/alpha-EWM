...
# Fan, Qi & Xu (2024), Table 5: n = 1500, alphas = {0.25, 0.3, 0.4, 0.5}
...
# For reasonable run time, we recommend running this script with at least 80 CPUs simultaneously, or breaking the for loop into smaller sub-tasks.
######################################
